...
import com.arktech.waqasansari.thescholarsinn.*;
import com.arktech.waqasansari.thescholarsinn.adapters.PagerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnShow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                com.arktech.waqasansari.thescholarsinn.adapters.PagerAdapter pagerAdapter = new PagerAdapter(getSupportFragmentManager(), bundle);
